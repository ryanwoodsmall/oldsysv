#	@(#)pass1.mk	1.3
#	VAX FORTRAN COMPILER PASS1 MAKEFILE

DEFS = -DHERE=VAX -DTARGET=VAX -DFAMILY=PCC
DIRCOM = ../../common/pass1
DIRMAC = .
...
f77:		driver.o vaxx.o
		$(CC) $(LDFLAGS) driver.o vaxx.o -o f77
		@$(SIZE) f77
...
vax.o:		$(DIRMAC)/vax.c $(INCLUDES) $(DIRCOM)/pccdefs
		$(CC) -c $(CFLAGS) $(DIRMAC)/vax.c
