...
XQTDIR=$(ROOT)/usr/lib/uucp/.XQTDIR
OLDLOG=$(ROOT)/usr/lib/uucp/.OLD
PKON=pkon.o
PKONSRC=pkon.c
LINE=line.o
LINESRC=line.c
...
cp:	all
	...
	$(CH)chmod 4111 $(BIN)/uulog
	$(CH)-chmod u+w $(INSDIR)/uuclean
	cp uuclean $(INSDIR)
	$(CH)chown $(OWNER) $(INSDIR)/uuclean
	$(CH)chmod 4111 $(INSDIR)/uuclean
	...
	$(CH)-chmod u+w $(INSDIR)/uusub
	cp uusub $(INSDIR)
	$(CH)chmod 100 $(INSDIR)/uusub
	$(CH)chown $(OWNER) $(INSDIR)/uusub
...
cpfiles:
	...
	$(CH)chmod 400 $(INSDIR)/L.sys $(INSDIR)/USERFILE
	$(CH)chmod 444 $(INSDIR)/L-*
	$(CH)chown $(OWNER) $(INSDIR)/*
