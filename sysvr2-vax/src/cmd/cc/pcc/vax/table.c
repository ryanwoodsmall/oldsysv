...
#ifdef FORT
SCONV,	INTAREG|FORCC,
	SAREG|AWD,	ANYSIGNED|TUNSIGNED|TULONG|TFLOAT|TDOUBLE,
	SANY,	TFLOAT,
...
SCONV,	INTAREG|FORCC,
	SAREG|SNAME|SCON|STARNM,	TWORD|TSHORT|TUSHORT,
	SANY,	ANYUSIGNED,
		NAREG|NASL,	RESC1|RESCC,
		"	movzZRl	AL,A1\n",

SCONV,	INTAREG|FORCC,
	SSOREG,	TWORD|TSHORT|TUSHORT,
	SANY,	ANYUSIGNED,
		NAREG|NASL,	RESC1|RESCC,
		"	movzZRl	AL,A1\n",
...
/* INCR and DECR for SAREG TCHAR|TSHORT matched by ASG PLUS etc */
...
OPLTYPE,	FORARG,
	SANY,	TANY,
	SAREG,	TCHAR|TUCHAR|TSHORT|TUSHORT,
		0,	RNULL,
		"	pushl	AR\n",
