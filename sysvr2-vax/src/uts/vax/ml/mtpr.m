...
#
	.set	CSRS,28		# console storage receive status
	.set	CSRD,29		# console storage receive data
	.set	CSTS,30		# console storage transmit status
	.set	CSTD,31		# console storage transmit data
	.set	TBDR,36		# translation buffer disable register
	.set	CADR,37		# cache disable register
	.set	MCESR,38	# machine check error summary register
	.set	CAER,39		# cache error
	.set	IORR,55		# i/o reset register
	.set	TB,59		# translation buffer
