...
struct	proc {
	...
	pgadr_t	p_ptaddr;	/* position of page tables in ptmap */
	pgadr_t	p_ptsize;	/* number of pages of page table */
...
#define	p_arg	p_unw.p_int
	...
	ushort	p_p0size;	/* P0 page table size */
	ushort	p_p1size;	/* P1 page table size */
