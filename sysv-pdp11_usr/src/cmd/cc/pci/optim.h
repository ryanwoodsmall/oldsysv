...
extern char *getspace(), *strcpy(), *strncpy(), *xalloc();
extern void addref(), fatal(), filter(), init(), optim(), prtext();
...
#define COPY(str, len)	((len) != 0 ? strncpy(getspace(len), str, (int)(len)) : str)
