...
all:	lint1 lint2 llib-lc.ln llib-port.ln llib-lm.ln
...
inslibs: llib-lc.ln llib-port.ln llib-lm.ln
	...
	$(INS) -n /usr/lib llib-lm
	$(INS) -n /usr/lib llib-lm.ln
install: all inslibs
	$(INS) -n /usr/lib lint1
	$(INS) -n /usr/lib lint2
	cp lint.sh lint
...
clean:
	rm -f *.o cgram.c
clobber: clean
	rm -f lint1 lint2 llib-lc.ln llib-port.ln llib-lm.ln lint
FRC:
