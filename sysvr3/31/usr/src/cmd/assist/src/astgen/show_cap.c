...
#ident	"@(#)tools:show_cap.c	1.6"
#include "../forms/muse.h"

#define   dotdot() {if (*c_pt!=null) mvaddstr(ci,75," ...");}

/*show_caption() is called by several routines to display the name
of the current field, along with a screen name*/
