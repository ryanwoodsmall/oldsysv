...
#define ONAMESIZ	(32)		/* size of an object's name */
#define DNAMESIZ	(15)		/* maximum size of an object's display name*/
...
struct ott_entry  {
	...
	long mtime;					/* modification time for object */
};
...
struct ott_tab  {
	...
	long ott_mtime;				/* mod time of the ott */
	long dir_mtime;				/* mod time of the unix directory */
	int  last_used;				/* higher numbers = more recently used */
