 ...
 *	All Rights Reserved
 */
#ident	"@(#)vm.vt:src/vt/vinit.c	1.14"
...
int labfmt;		/* format for the SLKS (3-2-3 or 4-4) */
{
	...
	static char	virt[] = "abdehiklnoprtuvwxyz";
	static char	virt_f[] = "12345678dbemruy";
	static token	tok_virt[] = {
		/* single key virtualizations */
		TOK_IC,		TOK_BEG,	TOK_DOWN,
		TOK_END,	TOK_BACKSPACE,	TOK_TAB,	TOK_DL,
		...
		TOK_SF,		TOK_HOME,	TOK_SHOME,	TOK_MARK,
		TOK_RESET,	TOK_SR,		TOK_SEOL,
	};
	token	*setvirt();
