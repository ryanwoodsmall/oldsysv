...
/*	static char  ID[] = "@(#)optim:3b/optutil.c	1.9";	*/
...
NODE * n;				/* instruction node to test */
{
    ...
    case MCOMW:
    /*
    case MOVZBH:			   because addressing different on
    case MOVZBW:			   register and memory -> messes
    case MOVZHW:			   up some opts in w2opt.c
    */
    case ANDW2:
    case ORW2:
    case XORW2:
