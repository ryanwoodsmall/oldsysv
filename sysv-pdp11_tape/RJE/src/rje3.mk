#	rje3.mk 1.3 of 3/9/82
#	@(#)rje3.mk	1.3

install:
	-mkdir /usr/rje3
	-chmod 755 /usr/rje3
	-chown rje /usr/rje3; chgrp bin /usr/rje3

	-mkdir /usr/rje3/spool
	-chmod 777 /usr/rje3/spool
	-chown rje /usr/rje3/spool; chgrp bin /usr/rje3/spool

	-mkdir /usr/rje3/rpool
	-chmod 755 /usr/rje3/rpool
	-chown rje /usr/rje3/rpool; chgrp bin /usr/rje3/rpool

	-mkdir /usr/rje3/squeue
	-chmod 755 /usr/rje3/squeue
	-chown rje /usr/rje3/squeue; chgrp bin /usr/rje3/squeue

	-mkdir /usr/rje3/job
	-chmod 777 /usr/rje3/job
	-chown rje /usr/rje3/job; chgrp bin /usr/rje3/job
	...
	cp /usr/src/cmd/rje/src/testjob1 /usr/rje3/testjob1
	-chown rje /usr/rje3/testjob1; chgrp bin /usr/rje3/testjob1
	cp /usr/src/cmd/rje/src/testjob2 /usr/rje3/testjob2
	-chown rje /usr/rje3/testjob2; chgrp bin /usr/rje3/testjob2
