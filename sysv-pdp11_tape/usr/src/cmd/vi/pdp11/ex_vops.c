...
#ifdef YANKDEL
	/*
	 * This code was taken out on the Onyx because it does strange
	 * things when left in.  I suspect a C compiler bug or kernel
	 * but but I am not sure.  The problem can be duplicated by
	 * editing any reasonably large file and doing about a dozen
	 * dd's in a row.  It says "bad file number" and drops out
	 * to command mode.
	 */
	/*
