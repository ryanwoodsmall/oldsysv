...
#define	EXRECOVER	libpath(ex2.15recover)
#define	EXPRESERVE	libpath(ex2.15preserve)
#define	EXSTRINGS	libpath(ex2.15strings)
...
#define	TUBESIZE	4800	/* Maximum screen size for visual */
