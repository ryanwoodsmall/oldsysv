...
struct	user
{
	...
	long	u_ioch;
	char	u_acflag;
	char	u_lock;			/* lock flag */
	short	u_cmask;		/* mask for file creation */
	daddr_t	u_limit;		/* maximum write address */
	struct {			/* MAUS mem mgt save area */
		int	ms_uisa;
		int	ms_uisd;
	} u_msav[NMSAV];
	char	u_mbitm;		/* MAUS bitmap -- MM Reg utilization */
	int	u_t[32];
	int	u_stack[1];
