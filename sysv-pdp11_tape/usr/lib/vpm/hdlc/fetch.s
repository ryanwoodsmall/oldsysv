...
xsomi:
/*
 * Save sync character for use later
 */
	mov	ioadr,mar
	mov	%ioadr,%mar
	mov	r5,mem
/*
 * Set process state = XENDWAIT
 */
	mov	XENDWAIT,brg
	mov	brg,r12
/*
 ...
 */
	...
	mov	mem,r7
/*
 * If X25FLAG is set then subtract length of packet header
 */
	mov	X25FLAG,brg
	orn	brg,r14,-
	brz	1f
 ...
 */
	...
	brc	stackerr
/*
 * If a timeout was started in the routine
 ...
 */
	...
	br0	jumperr
/*
 * If the jump address is out of range then error
 */
	mov	end,brg
	sub	brg,r0,-
	mov	%end,brg
