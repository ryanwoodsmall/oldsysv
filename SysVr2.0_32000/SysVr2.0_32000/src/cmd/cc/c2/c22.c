...
readonly char invbr[] = {	/* for reversing cmpl's to cmpv's */
	JEQ, JNE, JGE, JLE, JGT, JLT,
	JEQ, JNE, JHIS, JLOS, JHI, JLO,
	JBC, JBS, JLBC, JLBS, JBCC, JBSC, JBCS, JBSS };
