...
*/
/*
 * static char ID_filhdrh[] = "@(#) filehdr.h: 1.4 1/19/83";
 */
...
#define	U370ROMAGIC	0535	/* readonly sharable text segments	*/
	...
	/* NS32000 */
#define NS32WRMAGIC	0524	/* writeable text segments	*/
#define NS32ROMAGIC	0524	/* readonly shareable text segments */
#define NS32MDMAGIC	0525	/* module table magic */

/*
 * For NSC, switch VAX definitions so that source files need not be modified
 */

#ifdef ns32000
#undef	VAXWRMAGIC
#undef	VAXROMAGIC
#define	VAXWRMAGIC	NS32WRMAGIC
#define	VAXROMAGIC	NS32ROMAGIC
#endif
